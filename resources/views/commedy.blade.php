              ...
              <div class="col-lg-12 px-0">
                    <div class="owl-carousel main-carousel position-relative">
                            <div class="position-relative overflow-hidden mb-2" style="height: 500px;">
                                <img class="img-fluid h-100" src="img/commedybg.JPG" style="object-fit: cover;">
                                <div class="overlay mb-5 py-5" >
                                    <div class="mb-2">
                                        <a class="badge text-uppercase font-weight-semi-bold p-2 mr-2"
                                            href=""><b style="font-size: 50px;">Commedy Skits</b></a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 font-weight-bold" style="color:black">Recent Videos</h4>
                            ...
                            <div class="position-relative overflow-hidden" style="height: 300px;">
                                ...
                                <div class="overlay">
                                  <div class="mb-2">
                                   ...
                                   <a class="text-white" href=""><small>Jan 01, 2045</small>
                                  </a>
                        ...
                        <div class="col-lg-3">
                            <div class="position-relative overflow-hidden" style="height: 300px;">
                                    <img class="img-fluid h-100" src="img/oasdom.jpg" style="object-fit: cover;">
                                <div class="overlay">
                                  <div class="mb-2">
                        ...
                        <div class="col-lg-3">
                            <div class="position-relative overflow-hidden" style="height: 300px;">
                                    <img class="img-fluid h-100" src="img/commicpic.jpg" style="object-fit: cover;">
                                <div class="overlay">
                                  <div class="mb-2">
