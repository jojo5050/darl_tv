            ...
            <div class="row align-items-right bg-dark ">
                ...
                <div class="collapse navbar-collapse justify-content-between px-0 px-lg-2" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="https://www.darlcloudsoft.com" class="nav-item font-weight-bold nav-link">About</a>
              ...
              <div class="col-lg-12 px-0">
                    <div class="owl-carousel main-carousel position-relative">
                            <div class="position-relative overflow-hidden mb-2" style="height: 500px;">
                                <img class="img-fluid h-100" src="img/jobpic.png" style="object-fit: cover;">
                                <div class="overlay mb-5 py-5" >
                                    <div class="mb-2">
                                        <a class="badge text-uppercase font-weight-semi-bold p-2 mr-2"
                                            href=""><b style="font-size: 50px;">jobs</b></a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title justify-content-center">
                                <h4 class="m-0 text-uppercase font-weight-bold" style="color:black">Job Openings</h4>
                            </div>
                        </div>
                             <div class="col-lg-4" >
                                <div class="position-relative mb-3" >
                                    <div class="bg-career border border-top-0 p-4 text-center" Style="border-radius:20%">  
                                          <p class="h5 mt-3 mb-2  font-weight-bold" style="color:blue">
                                             Web Developer: Php/Laravel</p>
                                          <p class="mb-2 " style="color:black">Internship/Fulltime Roles</p>
                                        <div class="mb-1 text-align-left">
                                           <a class="badge badge-primary justify-content-center  font-weight-semi-bold p-2 mr-2"
                                            href="">Apply</a>
                                        </div>
                                    </div>
                                </div>
                             ...
                             <div class="col-lg-4">
                                <div class="position-relative mb-3">
                                    <div class="bg-career border border-top-0 p-4 text-center"  Style="border-radius:20%" >  
                                          <p class="h5 mt-3 mb-2  font-weight-bold" style="color:blue">
                                             Mobile Developer: Android/Flutter</p>
                                          <p class="mb-2 " style="color:black">Internship/Fulltime Roles</p>
                                        <div class="mb-1 text-align-left">
                                           <a class="badge badge-primary justify-content-center  font-weight-semi-bold p-2 mr-2"
                                            href="">Apply</a>
                             ...
                             <div class="col-lg-4">
                                <div class="position-relative mb-3">
                                    <div class="bg-career border border-top-0 p-4 text-center"  Style="border-radius:20%">  
                                          <p class="h5 mt-3 mb-2  font-weight-bold" style="color:blue">
                                             Java/Java Script Instructor</p>
                                          <p class="mb-2 " style="color:black">Fulltime</p>
                                        <div class="mb-1 text-align-left">
                                           <a class="badge badge-primary justify-content-center  font-weight-semi-bold p-2 mr-2"
                                            href="">Apply</a>
                                        </div>
