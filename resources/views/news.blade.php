              ...
              <div class="col-lg-12 px-0">
                    <div class="owl-carousel main-carousel position-relative">
                            <div class="position-relative overflow-hidden mb-2" style="height: 500px;">
                                <img class="img-fluid h-100" src="img/newsbg.JPG" style="object-fit: cover;">
                                <div class="overlay mb-5 py-5" >
                                    <div class="mb-2">
                                        <a class="badge text-uppercase font-weight-semi-bold p-2 mr-2"
                                            href=""><b style="font-size: 50px;">News</b></a>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="position-relative mb-3">
                                      <img class="img-fluid w-100" src="img/politics1.jpg" style="object-fit: cover;">
                                <div class="bg-white border border-top-0 p-4">                               
                                        <a class="h4 d-block mb-0 text-secondary font-weight-bold" href="">
                                            Lorem ipsum dolor sit amet elit...
                                        </a>
                        ...
                        <div class="col-lg-3">
                            <div class="position-relative mb-3">
                                      <img class="img-fluid w-100" src="img/politics2.jpg" style="object-fit: cover;">
                                <div class="bg-white border border-top-0 p-4">                               
                                        <a class="h4 d-block mb-0 text-secondary font-weight-bold" href="">
                                            Lorem ipsum dolor sit amet elit...
                                        </a>
                        ...
                        <div class="col-lg-3">
                            <div class="position-relative mb-3">
                                      <img class="img-fluid w-100" src="img/inter4.jpg" style="object-fit: cover;">
                                <div class="bg-white border border-top-0 p-4">                               
                                        <a class="h4 d-block mb-0 text-secondary font-weight-bold" href="">
                                            Lorem ipsum dolor sit amet elit...
                                        </a>
